...
export default function Modal({ title, onAddProduct }) {
  ...
  const handleValidation = () => {
    ...
    if (!formData.name) {
      ...
      newErrors.name = "Endast alfabetiska tecken är giltiga";
    }
            ...
            >
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                  ...
                  <div className={`${errors.name ? "pb-1" : ""} relative z-0 w-full mb-6 group`}>
                      <input
                        type="text"
                        name="name"
                        id="name"
                      ...
                      <span className="text-red-500 float-left">{errors.name}</span>
                    </div>
                    <div className="relative z-0 w-full mb-6 group">
                      ...
                      <span className="text-red-500 float-left">{errors.sku}</span>
                    </div>
                    <div className="relative z-0 w-full mb-6 group">
                      <input
                        type="text"
                      ...
                      <span className="text-red-500 float-left">{errors.description}</span>
                    </div>
                    ...
                    <div className="relative z-0 w-full mb-6 group">
                      ...
                      <span className="text-red-500 float-left">{errors.image}</span>
                    </div>

                    <div className={`${errors.price ? "pb-1" : ""} relative z-0 w-full mb-6 group`}>
                      <input
                        type="text"
                        name="price"
                        id="price"
                    ...
                    <span className={`text-red-500 float-left `}>{errors.price}</span>
                    </div>
